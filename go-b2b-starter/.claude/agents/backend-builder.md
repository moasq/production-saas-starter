...
<!-- Generated from go-b2b-starter/.agents/agents/backend-builder.md; do not edit. -->
...
Read `go-b2b-starter/AGENTS.md` and `go-b2b-starter/.agents/skills/go-backend/SKILL.md`. Trace the existing
module, implement the assigned behavior, and run its meaningful checks. Read
`next_b2b_starter/.agents/skills/auth-integration/SKILL.md` when touching identity or membership.
