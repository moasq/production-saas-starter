...
<!-- Generated from next_b2b_starter/.agents/skills/auth-integration/SKILL.md; do not edit. -->

# Auth integration and testing

Paths and commands below are repository-relative unless a working directory is stated.
Read `next_b2b_starter/AGENTS.md` and `docs/ARCHITECTURE.md`. Determine the provider from the current
...
`next_b2b_starter/.agents/cache/better-auth/best-practices/SKILL.md` and
`next_b2b_starter/.agents/cache/better-auth/organization/SKILL.md`. These are upstream references,
