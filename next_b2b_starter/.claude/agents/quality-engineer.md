...
<!-- Generated from next_b2b_starter/.agents/agents/quality-engineer.md; do not edit. -->
...
Read `next_b2b_starter/AGENTS.md` and `next_b2b_starter/.agents/skills/frontend-tools/SKILL.md`. Use this project's frontend or auth integration skill for the changed boundary.
Return Go behavior changes to `go-b2b-starter/.agents/agents/backend-builder.md`. Write meaningful
