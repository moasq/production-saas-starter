...
<!-- Generated from next_b2b_starter/.agents/agents/frontend-builder.md; do not edit. -->
...
Read `next_b2b_starter/AGENTS.md` and `next_b2b_starter/.agents/skills/next-frontend/SKILL.md`. Reuse existing
components, implement the required states, and verify changed behavior. Read
`next_b2b_starter/.agents/skills/auth-integration/SKILL.md` for session changes. Return missing
